...
<div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
    ...
    <div class="p-4">
        ...
        <a href="{{ route('books.show', $book) }}" class="mt-4 block text-center bg-brand-darkgreen text-white py-2 rounded hover:bg-brand-amber hover:text-brand-darkgreen transition-colors">
            View Details
        </a>
    </div>
</div>
