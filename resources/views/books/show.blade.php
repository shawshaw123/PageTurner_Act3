    ...
    <div class="md:flex">
        ...
        <div class="md:w-1/3 bg-gray-50 p-10 flex items-center justify-center border-b md:border-b-0 md:border-r border-gray-100">
            <div class="relative bg-white rounded-lg p-4 shadow-inner">
                <img src="{{ $imageUrl }}" alt="" class="max-h-[500px] shadow-2xl rounded-lg object-contain" 
                     loading="lazy"
                     decoding="async">
...
<div class="mt-8">
    <div class="flex justify-between items-center mb-6">
        ...
        @auth
            <a href="#review-form" class="bg-brand-darkgreen text-white px-4 py-2 rounded hover:bg-brand-amber hover:text-brand-darkgreen transition-colors">
                ✍️ Write a Review
            </a>
        @endauth
    </div>
    ...
    @auth
        <div id="review-form" class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <form action="{{ route('reviews.store', $book) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <small class="text-gray-500">Click to rate (1-5 stars)</small>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Comment</label>
                    <textarea name="comment" rows="4" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-brand-darkgreen focus:border-brand-darkgreen" placeholder="Share your thoughts about this book..." required></textarea>
                </div>
...
@include('partials.star-rating-js')
@endsection
