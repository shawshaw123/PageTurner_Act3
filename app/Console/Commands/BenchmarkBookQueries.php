...
class BenchmarkBookQueries extends Command
{
     ...
     * @var string
     */
    protected $signature = 'benchmark:book-queries 
     ...
     * @var string
     */
    protected $description = 'Benchmark book query performance against Lab 7 targets';
    ...
    public function handle(BookRepository $repository): int
    {
        ...
        $this->info('Lab 7 Query Performance Benchmark');
        $this->info('====================================');
    ...
    {
        $this->info('Benchmarking Full-Text Search (Target: < 300ms)');
        
        $request = new Request(['q' => 'fiction', 'per_page' => 50]);
        $times = [];
        
        // Warmup
        for ($i = 0; $i < $warmup; $i++) {
            $this->repository->search('fiction', $request, 50);
        }
    ...
    private function validateTargets(): void
    {
        ...
        $targets = [
            ...
            'fulltext_search' => 'Full-Text Search (< 300ms)',
        ];
